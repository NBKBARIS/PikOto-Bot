...
. <a className="text-white">(READ MESSAGES, SEND MESSAGES, EMBED LINKS, ATTACH FILES, READ MESSAGE HISTORY, CONNECT, SPEAK, USE VOICE ACTIVITY, PRIORITY SPEAKER)</a></p>
        ...
        <p>⊳ Oy Vermelisin for the <a className="text-white" href="Henüz Yok">PikOto</a> bot when using certain commands from the bot commands.</p>
        <div className="py-3"></div>
        <p>⊳ Her kullanıcı zarar vermek istemediği sürece PikOto botu dilediği gibi kullanabilir..</p>
        <div className="py-3"></div>
        <div className="py-3"></div>
        <p>⊳PikOto bot, kullanıcılara dayalı herhangi bir veri kaydetmez.</p>
        <div className="py-3"></div>
        <p>⊳ Botu kullanırken kullanıcı kimliğiniz bir defalığına sisteme kaydedilir ve silinir..</p> 
